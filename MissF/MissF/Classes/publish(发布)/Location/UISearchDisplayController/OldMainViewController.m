...
- (void)initCenterMarker
{
    ...
    _centerMaker.center = CGPointMake(self.view.frame.size.width / 2, (CGRectGetHeight(_mapView.bounds) -  _centerMaker.frame.size.height - NaviBar_HEIGHT) * 0.5);
    [self.view addSubview:_centerMaker];
}

- (void)initTableView
{
    _tableView = [[MapPoiTableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_mapView.frame)-NaviBar_HEIGHT, SCREEN_WIDTH, CELL_HEIGHT*CELL_COUNT + NaviBar_HEIGHT)];
