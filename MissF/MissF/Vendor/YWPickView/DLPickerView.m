...
#define PickerRowHieght                 45

#define PickerHeaderHieght              45
...
- (void)initPickerBackView {
    ...
    self.pickerBackView.backgroundColor = WHITECOLOR;
...
- (void)initPickerHeaderView {
    ...
    [cancelButton setTitleColor:GLOBALCOLOR forState:UIControlStateNormal];
    ...
    [confirmButton setTitleColor:GLOBALCOLOR forState:UIControlStateNormal];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    if (self.isSingleColumn) {
        UIView *contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, PickerRowHieght)];
        contentView.backgroundColor = ClearColor;
        UILabel *lb = [[UILabel alloc] init];
        lb.textColor = BLACKTEXTCOLOR;
        lb.font = FONT(15);
        lb.text = self.dataSource[row];
