...
@class YWSegmentTitleView;

@protocol YWSegmentTitleViewDelegate <NSObject>
...
@interface YWSegmentTitleView : UIView

@property (nonatomic, weak) id<YWSegmentTitleViewDelegate> delegate;
...
/**
 均分选项
 */
@property (nonatomic, assign) NSInteger AvgBtnCount;
