...
@interface MFAppHelper()<CLLocationManagerDelegate,UIAlertViewDelegate>
{
...
+ (instancetype)sharedInstance {
    ...
    static MFAppHelper *_cHAppHelper = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _cHAppHelper = [[MFAppHelper alloc] init];
    });
    return _cHAppHelper;
}
